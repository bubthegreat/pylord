...
Fifteen bundled IGMs ship here, all **enabled by default** -- `baraks_house`,
...
`arena_of_lords`, `the_latrine`, `werewolf`, `outlands_tavern`, and
`sunshines_fairy_land` -- from a few screens each to a full mini-game. A
