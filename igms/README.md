...
Thirteen bundled IGMs ship here, all **enabled by default** -- `baraks_house`,
...
`arena_of_lords`, `the_latrine`, and `werewolf` -- from a few screens each to
a full mini-game. A sysop who doesn't want one turns it off in
